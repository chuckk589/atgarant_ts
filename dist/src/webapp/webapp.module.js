...
exports.WebappModule = void 0;
const common_1 = require("@nestjs/common");
const webapp_service_1 = require("./webapp.service");
const webapp_controller_1 = require("./webapp.controller");
let WebappModule = class WebappModule {
};
WebappModule = __decorate([
    (0, common_1.Module)({
        controllers: [webapp_controller_1.WebappController],
        providers: [webapp_service_1.WebappService],
    })
], WebappModule);
