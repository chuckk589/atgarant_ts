...
export class ConfigSeeder extends Seeder {
  async run(em: EntityManager): Promise<void> {
    ...
    em.create(Configs, {
      name: 'QIWI_P2P_TOKEN',
      value:
        '48e7qUxn9T7RyYE1MVZswX1FRSbE6iyCj2gCRwwF3Dnh5XrasNTx3BGPiMsyXQFNKQhvukniQG8RTVhYm3iP6DSnuZLYioqzHc3Vu9WctymYC5U5Qk1X8C73ZjGANfRG5ara6pKoWcRbweJVPNcLjczji4NgLtvsx6LRWVeuncDiY5b9iU4MWw1M1HF36',
      category: 'QIWI',
      requiresReboot: 1,
    });
    em.create(Configs, {
    ...
    em.create(Configs, {
      ...
      value:
        'eyJ2ZXJzaW9uIjoiUDJQIiwiZGF0YSI6eyJwYXlpbl9tZXJjaGFudF9zaXRlX3VpZCI6IjhlamJ4cC0wMCIsInVzZXJfaWQiOiI3OTE2MTcyNDcyNiIsInNlY3JldCI6IjA0YTk4MTBhZWNjYjFjMDgzZGQzNjdlMWFkNTIxNWI1ZTBhNTEzYWNjNmQwZTVhNDFjNGI5NjA2NzdmNTA2YmUifX0=',
      category: 'QIWI',
      requiresReboot: 1,
    });
    em.create(Configs, {
